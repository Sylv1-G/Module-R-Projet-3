...
### Export des données sous la forme d'un fichier GPKG
...
Pour cela, une fonction export_list_to_gpkg a été crée. Elle prend en entrée la liste des 4 tableaux de données, une liste contenant les noms des couches du futur fichier gpkg créé, ainsi qu'un chemin d'accès à ce futur fichier. 
...
# Exporter en GPKG une liste de data frames ----
