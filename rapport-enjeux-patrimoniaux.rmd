...
servitude d'utilité publique est liée à un article de loi ou à un réglement des
...
Le géoportail de l'urbanisme (GPU) permet d'afficher les informations de différents documents d'organisme :    
...
d'urbanisme, SCOT ou SUP, existent pour notre zone d'étude, puis récupérer 
