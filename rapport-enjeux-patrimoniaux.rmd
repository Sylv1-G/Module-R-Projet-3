...
```{r, echo = FALSE}
knitr::kable(prescription_patrimoniale, caption = "liste des prescriptions retenues ayant trait aux enjeux patrimoniaux")
knitr::kable(info_patrimoniale, caption = "liste des informations retenues ayant trait aux enjeux patrimoniaux")
knitr::kable(sup_patrimoniale, caption = "liste des SUP retenues ayant trait aux enjeux patrimoniaux")
```
...
```{r setup, eval=T, include=T}

x <- get_wfs("O5O23", layer = "ADMINEXPRESS-COG.LATEST:commune")
...
print(get.gpu.prescription(x, dico))
